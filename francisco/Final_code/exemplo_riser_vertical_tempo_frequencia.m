...
flag_mass = 1;
flag_v_or_t = 1;
[w0_cons,phi0_cons,t1,y1,t2,y2,tt,vt,mg,kg, Deslocamentos]=fmnv_riser_tempo_frequencia(nos,elems,apoios,my,rho,ast, mi,flag_mass,F,flag_v_or_t);
...
%plot(t1,y1(:,3),t2,y2(:,3),tt,vt(3,:));
figure;
plot(tt,vt);
xlabel('Tempo (s)');
ylabel('Deslocamento (m)');
legend('Domínio da Frequência');
